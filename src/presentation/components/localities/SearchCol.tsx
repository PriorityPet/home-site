...
const SearchCol = () => {
    ...
    return (
        <div className="flex flex-col justify-start items-start gap-5 h-[60vh] w-1/4 bg-white rounded-md border border-slate-200 p-[2%_2%]">
            <div className="w-full border-b pb-5 flex justify-between items-center">
                ...
                <p className='text-sm font-medium text-slate-900 w-fit p-[1.5%_4%] bg-primary/20 rounded-md'>Centros: 7</p>
            </div>
            <DefaultInput
